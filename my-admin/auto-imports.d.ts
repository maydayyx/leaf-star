...
declare global {
  ...
  const IconEpCirclePlus: typeof import('~icons/ep/circle-plus')['default']
  const IconEpCollectionTag: typeof import('~icons/ep/collection-tag')['default']
  const IconEpDelete: typeof import('~icons/ep/delete')['default']
  const IconEpDocument: typeof import('~icons/ep/document')['default']
  const IconEpDocumentAdd: typeof import('~icons/ep/document-add')['default']
  const IconEpEdit: typeof import('~icons/ep/edit')['default']
  const IconEpFullScreen: typeof import('~icons/ep/full-screen')['default']
